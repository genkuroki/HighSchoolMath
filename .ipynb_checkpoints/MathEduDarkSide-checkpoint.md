...
```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/polynomial1852.jpg", scale="60%")
```

```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/polynomial1870.jpg", scale="50%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/equation1892.jpg", scale="55%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/19chuu_houkoku4_2_152.png"; scale="80%")
showimg("image/jpeg", "images/19chuu_houkoku4_2_153.png"; scale="80%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/gakkotosho-iko1.jpg", scale="80%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/gakkotosho-iko2.jpg", scale="80%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/gakkotosho-iko3.jpg", scale="80%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/png", "images/kumakura2006.png")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/png", "images/kumakura2016-1.png", scale="50%")
```

```julia slideshow={"slide_type": "-"}
showimg("image/png", "images/kumakura2016-2.png", scale="100%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/kaisetsu-baisu.jpg", scale="80%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/png", "images/baisu2.png", scale="80%")
```

```julia slideshow={"slide_type": "-"}
showimg("image/png", "images/baisu1.png", scale="80%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/png", "images/okayama-kakezan.png", scale="100%")
```
...
```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/kaisetsu-kakko1.jpg", scale="80%")
```

```julia slideshow={"slide_type": "-"}
showimg("image/jpeg", "images/kaisetsu-kakko2.png", scale="80%")
```
