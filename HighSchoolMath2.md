...
初期状態では壺の中にそういう $c$ 個の玉が入っていることになる.
...
上の計算では, $\Gamma(s+1)=s\Gamma(s)$ より $\Gamma(s+N)=(s+N-1)\cdots(s+1)s\Gamma(s)$ となることを使った.
...
using Random
Random.seed!(4649373)
anim_polya_urn(30, 70; gifname = "anim_polya_urn4649373.gif")
```
